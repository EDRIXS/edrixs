"""Consistency check for explicit and inferred serial SciPy RIXS dispatch."""
...
def test_explicit_and_inferred_serial_scipy_rixs_match(small_1v1c_problem):
    """Compare explicit and inferred backend dispatch through serial SciPy RIXS."""
